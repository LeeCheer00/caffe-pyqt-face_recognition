...
class Face_recognizer(QtCore.QThread):
    def __init__(self, textBrowser):
        ...
        # load face model
        caffemodel = '/home/leecheer/Project/deep_model/webface_vgg.caffemodel'
        deploy_file = '/home/leecheer/Project/deep_model/webface_vgg_deploy.prototxt'
        mean_file = None
        ...
        self.threshold = 0
        self.label = ['Stranger']
        self.db_path = '/home/leecheer/Project/db'
        #self.db = []
        self.db = None
        # load db
        self.load_db()
    ...
    def face_recognition(self, face_info):
        if self.recognizing:
            ...
            if len(img) != 0:
                ...
                msg = QtCore.QString("Face Recognition Pred: <span style='color:cyan'>{}</span>".format(' '.join([self.label[x] for x in pred])))
